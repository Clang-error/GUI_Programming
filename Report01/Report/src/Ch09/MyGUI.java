...
public class MyGUI extends JFrame {
    ...
    public MyGUI() {
        ...
        //현재rgb값 라벨
        Color test = c.getBackground();
        JLabel cRgb= new JLabel("");
        //줄넘김하려면 Html 형식 사용해야함 JLabel은 기본적으로 줄넘김을 지원하지않음
        cRgb.setText("<html>현재 배경<br>R: "+test.getRed()+" G: "+test.getGreen()+" B: "+test.getBlue()+"</html>");
        ...
        bscl.addAdjustmentListener(e->{
            ...
            cRgb.setText("R: "+current.getRed()+" G: "+current.getGreen()+" B: "+current.getBlue() );
        });
